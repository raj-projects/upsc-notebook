              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    title:
                      language === "en" ? "Practice Tests" : "प्रैक्टिस टेस्ट",
                    desc:
                      language === "en"
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              {language === "en"
                ...
                : "UPSC सफलता के लिए आवश्यक सब कुछ"}
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: "ri-book-line",
                title:
                  language === "en" ? "Subject Management" : "विषय प्रबंधन",
                desc:
                  language === "en"
              ...
              },
              {
                ...
                title:
                  language === "en" ? "OneNote Workspace" : "OneNote वर्कस्पेस",
                desc:
                  language === "en"
