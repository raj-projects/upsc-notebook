  ...
  const recentActivities = [
    {
      ...
      title:
        language === "en"
          ? "Created note: Indian Constitution"
          : "नोट बनाया: भारतीय संविधान",
      time: "2 hours ago",
    ...
    },
    {
      ...
      title:
        language === "en"
          ? "Completed Geography Mock Test"
          : "भूगोल मॉक टेस्ट पूरा किया",
      time: "5 hours ago",
    ...
    },
    {
      ...
      title:
        language === "en"
          ? "Study session: Modern History"
          : "अध्ययन सत्र: आधुनिक इतिहास",
      time: "1 day ago",
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                {language === "en"
                  ...
                  : "अपनी UPSC तैयारी की यात्रा जारी रखें"}
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  {
                    label: language === "en" ? "Create Note" : "नोट बनाएं",
                    icon: "ri-add-line",
                    href: "/notes",
                    color: "bg-blue-500",
                  },
                  {
                    label: language === "en" ? "Take Test" : "टेस्ट लें",
                    icon: "ri-file-list-3-line",
                    href: "/tests",
                    color: "bg-green-500",
                  },
                  {
                    label: language === "en" ? "Study Planner" : "अध्ययन योजना",
                  ...
                  {
                    label: language === "en" ? "Workspace" : "वर्कस्पेस",
                    icon: "ri-layout-grid-line",
                    href: "/workspace",
                    color: "bg-indigo-500",
                  },
                  ...
                  <Link key={index} href={action.href}>
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
                      <div
                        className={`w-12 h-12 flex items-center justify-center ${action.color} rounded-lg mx-auto mb-3 group-hover:scale-110 transition-transform`}
                      >
                ...
                <div className="space-y-4">
                  {recentActivities.map((activity, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      ...
                      >
                        <i
                          className={`${activity.icon} ${activity.color} text-sm`}
                        ></i>
                      </div>
